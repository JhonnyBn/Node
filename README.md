...
- Tente realizar GET em `localhost:3000/`
    - A seguinte mensagem de erro aparecerá: `{"auth":false,"token":null,"message":"Failed to authenticate token."}`
...
- Tente realizar GET novamente, com parâmetros de teste: `localhost:3000/teste?um=1&dois=2&tres=3&quatro=4`